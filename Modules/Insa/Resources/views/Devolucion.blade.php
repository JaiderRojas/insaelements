        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <table class="table table-bordered border-dark">
                        <tbody>
                            ...
                            <tr>
                             ...
                             <div class="row mb-3">
                        <label for="colFormLabel" class="col-sm-4 col-form-label col-form-label-sm">Nombre del Vigilante cuando salga del SENA:;</label>
                        <div class="col-sm-4">
                    ...
                    <div class="row mb-3">
                         <label for="colFormLabel" class="col-sm-4 col-form-label col-form-label-sm">Fecha de Salida:;</label>
                        <div class="col-sm-4">
                       <input class="form-control" type="text" placeholder="">
                   ...
                   <div class="row mb-3">
                         <label for="colFormLabel" class="col-sm-4 col-form-label col-form-label-sm">Nombre del Vigilante que Recibe:;</label>
                        <div class="col-sm-4">
                       <input class="form-control" type="text" placeholder="">
                    ...
                    <div class="row mb-3">
                       <label for="colFormLabel">Fecha de
                                    Entrada:</label>
                           <div class="col-sm-4">          
                         <input type="datetime" name="fecha"  value="<?php echo date("Y-m-d\ H-i");?>">
                           </div>    
                    </div>
